...
function Country_data(props) {
  ...
  var r = Math.min(Math.abs(parseFloat(correlation)), 1.8); //r = parseInt(Math.min(Math.abs(getPearsonCorrelation([34,37,24,67,42 ],[1.23,1.22, 1.23, 1.24, 1.25])), 1) * 100)

  var doughnut = [r, 1.8 - r];
  ...
  var barChartOptions = {
    ...
    scales: {
      xAxes: [{
        scaleLabel: {
          display: true,
          labelString: "Sales change of 1 " + props.tabs[props.select]['id'] + " price change"
        },
        gridLines: {
          color: "rgba(0, 0, 0, 0)"
        }
  ...
  }) : __jsx("p", null, "No enough data to analyze. Come back when you have more international orders :) You can do it!")), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_1__["Card"], {
...
//# sourceMappingURL=detect_transactions.js.29f970c3fc60eec15267.hot-update.js.map