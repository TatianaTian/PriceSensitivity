...
function Country_data(props) {
  ...
  function renderTooltip1(props) {
    ...
    }, "The score is price elasticity. It is", __jsx("br", null), "defined as the % demand change per 1%", __jsx("br", null), "price change. When score < 1, the market ", __jsx("br", null), "has low price sensitivty; when score <2,", __jsx("br", null), "the market has moderate price sensitivty;", __jsx("br", null), "when the score > 2, the market has high ", __jsx("br", null), "price sensitivity."));
  }
...
//# sourceMappingURL=detect_transactions.js.6dbeffee8bd7d503837a.hot-update.js.map