...
function Main_data(props) {
  ...
  var rows = [//['Emerald Silk Gown', '$875.00'],
    //['Mauve Cashmere Scarf', '$230.00'],
  ];
  countryListMap = props.countryListMap;
  ...
  for (var i = 0; i < currency_list.length; i++) {
    ...
    rows.push([currency, country_string]);
  }
...
//# sourceMappingURL=detect_transactions.js.666b85f5b93925962b4c.hot-update.js.map