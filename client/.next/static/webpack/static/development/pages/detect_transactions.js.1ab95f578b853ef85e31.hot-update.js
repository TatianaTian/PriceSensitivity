...
var fetch_from_map = function fetch_from_map(select, tabs, maps, product_id_title_map, dropdown_select, product_id_price_map, fx_map) {
  ...
  if (select !== 0) {
    ...
    var _price_elasticity = _price_elasticity(selected_data[1], product_price_list, Math.abs(slope));
    ...
    localStorage.setItem('correlation', _price_elasticity); //localStorage.setItem('regression_fx', regression_fx);
...
//# sourceMappingURL=detect_transactions.js.1ab95f578b853ef85e31.hot-update.js.map