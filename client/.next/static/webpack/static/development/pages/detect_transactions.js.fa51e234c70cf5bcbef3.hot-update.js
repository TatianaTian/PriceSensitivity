...
function Country_data(props) {
  ...
  var handleSelectChange = Object(react__WEBPACK_IMPORTED_MODULE_2__["useCallback"])(function (value) {
  ...
  if (date_string.includes(',')) {
    ...
    current_level = string_to_list(store_js__WEBPACK_IMPORTED_MODULE_5___default.a.get('current_level'), 'float');
  }
  ...
  function renderTooltip1(props) {
    return __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_6__["Tooltip"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
      id: "button-tooltip"
    }, props, {
      style: _objectSpread({
    ...
    }, "The score is price elasticity. The", __jsx("br", null), "way to calculat is the % demand change", __jsx("br", null), "per 1% price change. When the score < 1, ", __jsx("br", null), "the market has low price sensitivty; ", __jsx("br", null), "when the score <2, the market has moderate  ", __jsx("br", null), "price sensitivty; when the score > 2, the market", __jsx("br", null), "has high price sensitivity."));
  }
  ...
  var Example1 = function Example1() {
    return __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_6__["OverlayTrigger"], {
      placement: "bottom",
      delay: {
        show: 100,
        hide: 400
    ...
    }, __jsx(react_icons_fa__WEBPACK_IMPORTED_MODULE_7__["FaRegQuestionCircle"], null));
  };
  ...
  return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_3__["Layout"], {
    sectioned: false
  }, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_3__["Layout"].Section, {
    oneHalf: true
  }, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_3__["Select"], {
    label: "Analytics on",
    labelInline: true,
    options: options,
    ...
    sectioned: true
  }, __jsx(Example1, null), __jsx(react_chartjs_2__WEBPACK_IMPORTED_MODULE_4__["Doughnut"], {
    height: "100vh",
    ...
    sectioned: true
  }, __jsx(Example2, null), product_array_rank[0] !== "" ? __jsx(react_chartjs_2__WEBPACK_IMPORTED_MODULE_4__["HorizontalBar"], {
    height: "100vh",
    data: barChartData,
    options: barChartOptions
  }) : __jsx("p", null, "No enough data. Come back when you have more international orders :) You can do it!")), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_3__["Card"], {
    title: "Price And Sales By Date",
    sectioned: true
  }, __jsx(Example3, null), __jsx(react_chartjs_2__WEBPACK_IMPORTED_MODULE_4__["Bar"], {
    height: "220vh",
    data: lineChartData,
    ...
    sectioned: true
  }, __jsx(Example4, null), __jsx(react_chartjs_2__WEBPACK_IMPORTED_MODULE_4__["Bar"], {
    height: "150vh",
...
//# sourceMappingURL=detect_transactions.js.fa51e234c70cf5bcbef3.hot-update.js.map