  ...
  var barChartOptions = {
    ...
    scales: {
      xAxes: [{
        scaleLabel: {
          display: true,
          labelString: "Sales change in " + {
            store_currency: store_currency
          } + " with 1 " + props.tabs[props.select]['id'] + " price change"
        },
        gridLines: {
          color: "rgba(0, 0, 0, 0)"
        }
...
//# sourceMappingURL=detect_transactions.js.a2e26089f56b32cd15af.hot-update.js.map